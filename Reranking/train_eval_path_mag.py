...
def parse_args():
    ...
    # paths
    parser.add_argument("--train_path", type=str, default=f"/home/yongjia/dgl/Yongjia/MOE_20250222/mag_train.pkl", help="Path to the training data.")
    parser.add_argument("--test_path", type=str, default=f"/home/yongjia/dgl/Yongjia/MOE_20250222/mag_test.pkl", help="Path to the test data.")
    parser.add_argument("--val_path", type=str, default=f"/home/yongjia/dgl/Yongjia/MOE_20250222/mag_val.pkl", help="Path to the validation data.")
